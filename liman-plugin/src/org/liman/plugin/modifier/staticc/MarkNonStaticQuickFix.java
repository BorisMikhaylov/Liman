...
public class MarkNonStaticQuickFix extends LocalQuickFixOnPsiElement {
    ...
    @NotNull String getText() {
        return "Make it non static text";
    }

    @Override
    public @IntentionFamilyName
    @NotNull String getFamilyName() {
        return "Make it non static family";
    }
    ...
    public void invoke(@NotNull Project project, @NotNull PsiFile psiFile, @NotNull PsiElement psiElement, @NotNull PsiElement psiElement1) {
        ...
        modifierListElement.setModifierProperty(PsiModifier.STATIC, false);
    }
}
